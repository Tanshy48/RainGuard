...
class LocationsCity:AppCompatActivity() {
    ...
    val citiesZaporizhzhia = arrayOf(
        "Запоріжжя",
        "Мелітополь",
        "Бердянськ",
        "Енергодар",
    ...
    val citiesIvanoFrankivsk = arrayOf(
        "Івано-Франківськ",
        "Калуш",
        "Коломия",
        "Богородчани",
